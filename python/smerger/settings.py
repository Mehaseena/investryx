...
CSRF_TRUSTED_ORIGINS = ["https://investryx.com"]
CSRF_ALLOWED_ORIGINS = ["https://investryx.com"]
CORS_ORIGINS_WHITELIST = ["https://investryx.com"]
...
ASGI_APPLICATION = 'smerger.wsgi.application'
