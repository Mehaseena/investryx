//
// /// Data external aayitt edukunna method ///
//
...
//     var options = {
//       'key': 'rzp_test_l5y7T0LlpGjuTh', // Replace with your key
...
//     // Return an empty container to avoid showing any UI
//     return Container();
//   }
// }
...
class _PayMoneyState extends State<PayMoney> {
  ...
  Widget build(BuildContext context) {
    ...
    Timer(Duration(seconds: 2), () {
      Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> PricingPage()));
