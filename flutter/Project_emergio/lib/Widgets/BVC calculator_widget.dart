      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            const Text(
              "At Emergio, We Define Business Valuation As A Technique Used To Capture The True Value Of The Business. Common Approaches To Business Valuation Include Discounted Cash Flow (DCF), Trading Comparables, And Transaction Comparables Method Described Below.",
