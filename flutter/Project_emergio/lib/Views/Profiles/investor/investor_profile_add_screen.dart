...
class AddInvestorProfileScreen extends StatefulWidget {
  const AddInvestorProfileScreen({Key? key}) : super(key: key);
        ...
        if (mounted) {
          if (response == true) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Investor profile created successfully!'),
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              const SnackBar(
                content: Text('Failed to create investor profile. Please try again.'),
      ...
      children: [
        ...
        _buildTextField(
          ...
          validator: (value) {
            ...
            if (value.length < 2) {
              return 'Investor name must be at least 2 characters';
            }
            return null;
          },
        ),
