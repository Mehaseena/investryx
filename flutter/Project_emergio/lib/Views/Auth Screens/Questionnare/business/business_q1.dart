...
class BusinessQuestionnareScreen1 extends StatefulWidget {
  ...
  @override
  State<BusinessQuestionnareScreen1> createState() => _BusinessQuestionnareScreen1State();
}

class _BusinessQuestionnareScreen1State extends State<BusinessQuestionnareScreen1>
  ...
  final List<Map<String, dynamic>> options = [
    ...
    {
      'title': 'Looking for buying business',
      'icon': Icons.shopping_bag_outlined,
      'description': 'Interested in acquiring an existing business',
    },
  ];
        ...
        appBar: PreferredSize(
          ...
          child: AppBar(
            ...
            leading: GestureDetector(
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => QuestionnareScreen1(city: widget.city, state: widget.state,))),
              child: Padding(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8.h),
                  Text(
                    'Select the current stage of your business journey',
                    style: TextStyle(
                      fontSize: 15.sp,
                  ...
                  onPressed: selectedOption != null
                      ? () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => BusinessQuestionnareScreen2(
                                  city: widget.city,
                                  state: widget.state,
