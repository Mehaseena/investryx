...
import 'investor_q2.dart';
  ...
  class InvestorQuestionnareScreen1 extends StatefulWidget {
    ...
    @override
    State<InvestorQuestionnareScreen1> createState() => _InvestorQuestionnareScreen1State();
  }

  class _InvestorQuestionnareScreen1State extends State<InvestorQuestionnareScreen1>
                    ...
                    child: ElevatedButton(
                      onPressed: selectedOption != null ? () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => InvestorQuestionnareScreen2(
                              city: widget.city,
                              state: widget.state,
                              type: widget.type,
