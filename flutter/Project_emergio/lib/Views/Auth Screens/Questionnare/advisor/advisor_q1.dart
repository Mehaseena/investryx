...
class AdvisorQuestionnareScreen1 extends StatefulWidget {
  ...
  @override
  State<AdvisorQuestionnareScreen1> createState() => _AdvisorQuestionnareScreen1State();
}
...
class _AdvisorQuestionnareScreen1State extends State<AdvisorQuestionnareScreen1>
  ...
  List<Map<String, dynamic>> get filteredExpertise => searchQuery.isEmpty
      ...
      : expertiseAreas
      .where((area) =>
      area['title'].toString().toLowerCase().contains(searchQuery.toLowerCase()))
      .toList();
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final isSelected = selectedOptions.contains(expertise['title']);
                  ...
                  child: ElevatedButton(
                    onPressed: selectedOptions.isNotEmpty ? () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => AdvisorQuestionnareScreen2(
                            city: widget.city,
                            state: widget.state,
                            type: widget.type,
